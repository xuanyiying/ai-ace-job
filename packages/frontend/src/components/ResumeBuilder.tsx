...
const GLASS_CARD = "bg-white/5 backdrop-blur-2xl border border-white/10 rounded-[2rem] p-8 shadow-2xl transition-all duration-500 hover:border-white/20";
const INPUT_BASE = "w-full bg-transparent border-b border-white/10 py-3 focus:border-white/40 focus:outline-none transition-all text-white placeholder-white/20 font-medium";
    ...
    >
      ...
      >
        <div className="max-w-[1800px] mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <button onClick={handleResetToDefault} className={BUTTON_SECONDARY} title="Reset to default">
              <RotateCcw size={18} />
            </button>
            <div className="h-6 w-[1px] bg-white/10 mx-2" />
      ...
      <main className="max-w-[1600px] mx-auto p-6 lg:p-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className={`lg:col-span-4 space-y-8 ${!isEditView ? 'hidden lg:block opacity-50 pointer-events-none' : ''}`}>
            <div>
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-sm font-bold uppercase tracking-widest text-white/40">Resume Sections</h2>
                <button onClick={handleAddSection} className="p-2 hover:bg-white/10 rounded-lg transition-colors text-white/60 hover:text-white">
                  <Plus size={20} />
                </button>
              </div>
                ...
                {sections.map((section) => (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                      <button 
                        onClick={(e) => { e.stopPropagation(); handleDuplicateSection(section.id); }}
                  ...
                  {activeSection ? (
                    <div className="space-y-12">
                      <div className="space-y-4">
                        <label className="text-[10px] font-black uppercase tracking-[0.3em] text-white/20">Section Title</label>
                        <input 
                          ref={sectionTitleRef}
                      ...
                      <div className="space-y-6">
                        <div className="flex items-center justify-between">
                          <label className="text-[10px] font-black uppercase tracking-[0.3em] text-white/20">Content Editor</label>
                          <span className="text-[10px] font-bold text-white/10 uppercase tracking-widest bg-white/5 px-3 py-1 rounded-full">Markdown v4.0</span>
                        </div>
                        <textarea 
      ...
      <footer className="fixed bottom-0 left-0 right-0 px-6 py-3 border-t border-white/5 bg-black/40 backdrop-blur-xl flex items-center justify-between text-[10px] font-bold uppercase tracking-[0.2em] text-white/20">
        ...
        <div className="flex items-center gap-6">
          <span className="flex items-center gap-2"><div className="w-1.5 h-1.5 rounded-full bg-green-500 shadow-[0_0_8px_rgba(34,197,94,0.6)]" /> System Ready</span>
          <span>v1.0.0</span>
        </div>
      </footer>
